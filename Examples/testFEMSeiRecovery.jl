...
#FEMSei.DivMomentumVector!(backend,FTB,Rhs,uHDiv,RT,uVecDG,VecDG,RT,Grid,Grids.Quad(),nQuad,FEMSei.Jacobi!)
FEMSei.DivMomentumScalar!(backend,FTB,Rhs,uHDiv,RT,uDG,DG,DG,Grid,Grids.Quad(),nQuad,FEMSei.Jacobi!)
  stop
